Данный проект содержит некоммерческое приложение позволяющее пользователю сохранять свое состояние в течении дня, а также отсматривать подробную статистику по ним
