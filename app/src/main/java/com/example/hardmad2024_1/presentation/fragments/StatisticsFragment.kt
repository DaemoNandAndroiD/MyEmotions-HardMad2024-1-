...
import com.example.hardmad2024_1.presentation.util.classes.DuringDayStatisticsData
import com.example.hardmad2024_1.presentation.util.classes.GeneralStatisticsData
import com.example.hardmad2024_1.presentation.util.adapters.HorizontalViewPagerAdapter
        ...
        val adapter = HorizontalViewPagerAdapter(this,
            listOf(
                VerticalFragmentData(
                    ...
                    arrayOf(
                        OftenStatisticsData("Спокойствие", 1f,4,
                        R.drawable.ic_green_emote,
                        R.drawable.green_often_stat
                    ),
                        OftenStatisticsData("Продуктивность", 0.75f, 3,
                            R.drawable.ic_yellow_emote,
                            R.drawable.yellow_often_stat
                        ),
                        OftenStatisticsData("Счастье", 0.5f, 2,
                            R.drawable.ic_yellow_emote_2,
                            R.drawable.yellow_often_stat
                        ),
                        OftenStatisticsData("Выгорание", 1f, 4,
                            R.drawable.ic_blue_emote,
                            R.drawable.blue_often_stat
                        ),
                        OftenStatisticsData("Усталость", 0.25f, 1,
                            R.drawable.ic_blue_emote_2,
                            R.drawable.blue_often_stat
                        )
                    ),
                    arrayOf(
                        DuringDayStatisticsData(1, listOf(1), listOf(R.drawable.green_vertical_stat)),
                        DuringDayStatisticsData(3, listOf(1,1,1), listOf(
                            R.drawable.yellow_vertical_stat,
                            R.drawable.green_vertical_stat,
                            R.drawable.red_vertical_stat
                        )),
                        DuringDayStatisticsData(10, listOf(1,2,3,4), listOf(
                            R.drawable.yellow_vertical_stat,
                            R.drawable.green_vertical_stat,
                            R.drawable.red_vertical_stat,
                            R.drawable.blue_vertical_stat
                        )),
                        DuringDayStatisticsData(8, listOf(2,2,2,2), listOf(
                            R.drawable.red_vertical_stat,
                            R.drawable.blue_vertical_stat,
                            R.drawable.yellow_vertical_stat,
                            R.drawable.green_vertical_stat
                        )),
                        DuringDayStatisticsData(2, listOf(1,1), listOf(
                            R.drawable.red_vertical_stat,
                            R.drawable.yellow_vertical_stat
                        ))
                    )
                ...
                VerticalFragmentData(
                    GeneralStatisticsData(10,listOf(20f,40f, 20f, 20f)),
                    arrayOf(
                        WeekStatisticsData(
                        date = "24 февраля",
                        dayOfWeek = getString(R.string.first_day),
                        ...
                        OftenStatisticsData("Беспокойство", 1f,10,
                        R.drawable.ic_red_emote,
                        R.drawable.red_often_stat
                    ),
                        OftenStatisticsData("Зависть", 1f, 10,
                            R.drawable.ic_red_emote,
                            R.drawable.red_often_stat
                        )
                    ),
                    arrayOf(
                        DuringDayStatisticsData(10, listOf(1,9), listOf(
                        R.drawable.green_vertical_stat,
                        R.drawable.red_vertical_stat
                    )),
                        DuringDayStatisticsData(3, listOf(1,1,1), listOf(
                        ...
                        DuringDayStatisticsData(40, listOf(21,17,2), listOf(
                            R.drawable.blue_vertical_stat,
                            R.drawable.green_vertical_stat,
                            R.drawable.red_vertical_stat
                        )),
                        DuringDayStatisticsData(12, listOf(2,5,1,4), listOf(
                            R.drawable.red_vertical_stat,
                            R.drawable.blue_vertical_stat,
                            R.drawable.yellow_vertical_stat,
                            R.drawable.green_vertical_stat
                ...
                VerticalFragmentData(
                    ...
                    duringDayStatisticsData = arrayOf(
                        DuringDayStatisticsData(0, listOf(), listOf()),
                        DuringDayStatisticsData(0, listOf(), listOf()),
                        DuringDayStatisticsData(0, listOf(), listOf()),
                        DuringDayStatisticsData(0, listOf(), listOf()),
